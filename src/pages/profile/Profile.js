...
export default function Profile() {
  ...
  async function handlegetpastorders() {
    const res = await axios.post(
      "https://www.rrestaurantbk.shoponlinemarket.cloud/api/orders/getuserorders",
      { message: "hello" },
      {
...
export const ProfileLoader = async ({}) => {
  const res = await axios.post(
    "https://www.rrestaurantbk.shoponlinemarket.cloud/api/users/profile",
    { message: "hello" },
    {
      withCredentials: true,
      headers: {
...
export const ProfileAction = async ({ request }) => {
  ...
  const datas = await axios.post(
    "https://www.rrestaurantbk.shoponlinemarket.cloud/api/users/updateinfo",
    {
      submission,
    },
    {
